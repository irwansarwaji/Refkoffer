...
public class EmployeeDashboardController implements Initializable {
    ...
    private void fillList() throws SQLException {
        ...
        while (rs.next()) {
            ...
            Baggage baggage = new Baggage(rs.getInt("id"), rs.getString("suitcase_label"), rs.getString("country"), rs.getInt("suitcase_type"), rs.getString("suitcase_color"), rs.getString("first_name"), rs.getString("last_name"), rs.getString("email"), rs.getString("airport_site"));
